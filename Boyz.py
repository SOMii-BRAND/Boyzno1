...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;92m[1]  START CLONING PAKISTAN'
    time.sleep(0.10)
...
def action():
    ...
    if peak =='':
        ...
        print '\033[1;92mEnter any code 1 to 59'
        print '\033[1;92Only Pak phone number'
        try:
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan("\033[0;91m Pakistan CLONING") 
    jalan("\033[0;92mALL OLD IDS")
    jalan("\033[0;93mREAL STAR '")
    jalan("\033[0;94mWHATAAP")
    jalan("\033[0;95m03455453538")
